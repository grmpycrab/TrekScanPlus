...
class _CommentThreadState extends State<CommentThread> {
  ...
  Future<void> _checkLikedStatus() async {
    if (widget.comment.id != null) {
      final liked = await SocialRepository.instance.isCommentLiked(
        widget.postId,
        widget.comment.id!,
      );
  ...
  Future<void> _toggleLike() async {
    ...
    try {
      await SocialRepository.instance.toggleCommentLike(
        widget.postId,
        widget.comment.id!,
      );
    } catch (e) {
  ...
  Future<void> _deleteComment() async {
    ...
    try {
      await SocialRepository.instance.deleteComment(
        widget.postId,
        widget.comment.id!,
      );
      if (mounted) {
  ...
  void _showOptionsMenu() {
    ...
    AppDialogueHandler.showChoice<String>(
      ...
      if (action == 'delete') _deleteComment();
    });
  }
        ...
        if (_showReplies && widget.comment.id != null)
          Padding(
            ...
            child: StreamBuilder<List<Reply>>(
              stream: SocialRepository.instance.streamReplies(
                widget.postId,
                widget.comment.id!,
              ),
...
class _ReplyTileState extends State<ReplyTile> {
  ...
  Future<void> _checkLikedStatus() async {
    if (widget.reply.id != null) {
      final liked = await SocialRepository.instance.isReplyLiked(
        widget.postId,
        widget.commentId,
        widget.reply.id!,
      );
  ...
  Future<void> _toggleLike() async {
    ...
    try {
      await SocialRepository.instance.toggleReplyLike(
        widget.postId,
        widget.commentId,
        widget.reply.id!,
      );
  ...
  Future<void> _deleteReply() async {
    ...
    try {
      await SocialRepository.instance.deleteReply(
        widget.postId,
        widget.commentId,
        widget.reply.id!,
      );
